...
| [`tools-pod-chokepoint.md`](tools-pod-chokepoint.md) | Draft/deferred: out-of-pod successor to the removed cooperative tool tier — tools pod, credential mediation, ext_authz, approval holds at the chokepoint. |
