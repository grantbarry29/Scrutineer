...
func (Backend) Kind() enforcement.BackendKind {
	return enforcement.BackendToolGateway
}

func (Backend) Capabilities() enforcement.Capabilities {
	return enforcement.Capabilities{Tools: true}
}

// DesiredState returns *GatewayConfig when tool policy or an enabled tool-gateway sidecar applies.
