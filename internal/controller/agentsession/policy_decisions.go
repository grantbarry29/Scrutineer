...
func ApplyPolicyStatus(session *relayv1alpha1.AgentSession, resolved policy.Resolved, priorDecisions []relayv1alpha1.PolicyDecision) {
...
func RuntimePolicyDecisions(decisions []relayv1alpha1.PolicyDecision) []relayv1alpha1.PolicyDecision {
	if len(decisions) == 0 {
		return nil
	}
	out := make([]relayv1alpha1.PolicyDecision, 0, len(decisions))
...
func policyDecisionKey(d relayv1alpha1.PolicyDecision) string {
...
func mergeRuntimePolicyDecisionsInPlace(dst *[]relayv1alpha1.PolicyDecision, preserve []relayv1alpha1.PolicyDecision) {
	if dst == nil {
		return
	}
	...
	var missing []relayv1alpha1.PolicyDecision
