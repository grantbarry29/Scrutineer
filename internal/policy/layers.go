...
func LoadPolicyLayers(ctx context.Context, c client.Reader, session *scrutineerv1alpha1.AgentSession) ([]Layer, error) {
	var layers []Layer
...
func validatePolicyRef(ref scrutineerv1alpha1.PolicyRef, index int) error {
