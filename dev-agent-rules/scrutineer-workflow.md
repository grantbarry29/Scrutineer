...
Use this shape for the body of a new **GitHub Issue** (also handy when an existing issue needs a clearer scope). This is the **single** canonical template — `task-management.md` points here. Keep it tight:
